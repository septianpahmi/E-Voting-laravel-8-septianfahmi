        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <!-- Horizontal Form -->
                  <form action="{{url('/datacalon/edit/post',$data->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                      <label for="nisn" class="col-sm-8 col-form-label">NISN</label>
                      <div class="col-sm-12">
                        <input type="number" class="form-control" name="nisn" id="nisn" required value="{{$data->nisn}}">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="nomor" class="col-sm-8 col-form-label">Nomor Calon Kandidat</label>
                      <div class="col-sm-12">
                        <input type="number" class="form-control" name="nomor" id="nomor" required value="{{$data->nomor}}">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="nm_kandidat" class="col-sm-8 col-form-label">Nama Calon Kandidat</label>
                      <div class="col-sm-12">
                        <input type="text" class="form-control" name="nm_kandidat" id="nm_kandidat" required value="{{$data->nm_kandidat}}">
                      </div>
                    </div>
                    <div class="row mb-3">
